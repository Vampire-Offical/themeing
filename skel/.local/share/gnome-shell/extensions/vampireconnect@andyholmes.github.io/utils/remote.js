...
const SERVICE_NAME = 'org.gnome.Shell.Extensions.VampireConnect';
const SERVICE_PATH = '/org/gnome/Shell/Extensions/VampireConnect';
const DEVICE_NAME = 'org.gnome.Shell.Extensions.VampireConnect.Device';
const DEVICE_PATH = '/org/gnome/Shell/Extensions/VampireConnect/Device';
...
var Device = GObject.registerClass({
    GTypeName: 'VampireConnectRemoteDevice',
...
/**
 * A simple proxy wrapper for the VampireConnect service.
 */
var Service = GObject.registerClass({
    GTypeName: 'VampireConnectRemoteService',
    Implements: [Gio.DBusInterface],
    Properties: {
