...
const SectionRow = GObject.registerClass({
    GTypeName: 'VampireConnectPreferencesSectionRow',
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/preferences-section-row.ui',
...
const CommandEditor = GObject.registerClass({
    GTypeName: 'VampireConnectPreferencesCommandEditor',
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/preferences-command-editor.ui',
    Children: [
...
var Panel = GObject.registerClass({
    GTypeName: 'VampireConnectPreferencesDevicePanel',
    Properties: {
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/preferences-device-panel.ui',
    Children: [
    ...
    _queryApplications(settings) {
        ...
        const ignoreId = 'org.gnome.Shell.Extensions.VampireConnect.desktop';
