...
VampireConnect: ${Config.PACKAGE_VERSION} (${Config.IS_USER ? 'user' : 'system'})
...
async function generateSupportLog(time) {
    try {
        const [file, stream] = Gio.File.new_tmp('vampireconnect.XXXXXX');
...
var ConnectDialog = GObject.registerClass({
    GTypeName: 'VampireConnectConnectDialog',
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/connect-dialog.ui',
    Children: [
...
var Window = GObject.registerClass({
    GTypeName: 'VampireConnectPreferencesWindow',
    Properties: {
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/preferences-window.ui',
    Children: [
        // HeaderBar
    ...
    _restoreGeometry() {
        this._windowState = new Gio.Settings({
            settings_schema: Config.GSCHEMA.lookup(
                'org.gnome.Shell.Extensions.VampireConnect.WindowState',
                true
            ),
            path: '/org/gnome/shell/extensions/vampireconnect/preferences/',
        });
        ...
        if (this._about === undefined) {
            this._about = new Gtk.AboutDialog({
                ...
                logo: GdkPixbuf.Pixbuf.new_from_resource_at_scale(
                    '/org/gnome/Shell/Extensions/VampireConnect/icons/org.gnome.Shell.Extensions.VampireConnect.svg',
                    128,
                    128,
                    true
                ),
                program_name: 'VampireConnect',
