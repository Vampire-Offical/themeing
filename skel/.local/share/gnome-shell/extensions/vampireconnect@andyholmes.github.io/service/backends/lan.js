...
var ChannelService = GObject.registerClass({
    GTypeName: 'VampireConnectLanChannelService',
    Properties: {
...
var Channel = GObject.registerClass({
    GTypeName: 'VampireConnectLanChannel',
    ...
    async _authenticate(connection) {
        ...
        if (this.device) {
            ...
            settings = new Gio.Settings({
                ...
                path: `/org/gnome/shell/extensions/vampireconnect/device/${id}/`,
            });
        }
    ...
    async download(packet, target, cancellable = null) {
        ...
        //       https://github.com/VampireConnect/gnome-shell-extension-vampireconnect/issues/1157
