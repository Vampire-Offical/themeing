...
var DeviceChooser = GObject.registerClass({
    GTypeName: 'VampireConnectServiceDeviceChooser',
    Properties: {
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/service-device-chooser.ui',
...
var ErrorDialog = GObject.registerClass({
    GTypeName: 'VampireConnectServiceErrorDialog',
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/service-error-dialog.ui',
    Children: [
        'error-stack',
        'expander-arrow',
        'gesture',
    ...
    _init(error) {
        super._init({
            application: Gio.Application.get_default(),
            title: `VampireConnect: ${error.name}`,
        });
        this.set_keep_above(true);
