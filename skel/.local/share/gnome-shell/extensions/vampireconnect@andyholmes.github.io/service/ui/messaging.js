...
const ConversationMessage = GObject.registerClass({
    GTypeName: 'VampireConnectMessagingConversationMessage',
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/messaging-conversation-message.ui',
...
const Conversation = GObject.registerClass({
    GTypeName: 'VampireConnectMessagingConversation',
    Properties: {
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/messaging-conversation.ui',
    Children: [
        'entry', 'list', 'scrolled',
        'pending', 'pending-box',
    ],
...
const ConversationSummary = GObject.registerClass({
    GTypeName: 'VampireConnectMessagingConversationSummary',
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/messaging-conversation-summary.ui',
...
var Window = GObject.registerClass({
    GTypeName: 'VampireConnectMessagingWindow',
    Properties: {
        'device': GObject.ParamSpec.object(
            'device',
            'Device',
    ...
    Template: 'resource:///org/gnome/Shell/Extensions/VampireConnect/ui/messaging-window.ui',
    Children: [
        'headerbar', 'infobar',
        'thread-list', 'stack',
    ],
...
var ConversationChooser = GObject.registerClass({
    GTypeName: 'VampireConnectConversationChooser',
    Properties: {
        'device': GObject.ParamSpec.object(
            'device',
            'Device',
