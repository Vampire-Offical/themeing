...
var Metadata = {
    ...
    id: 'org.gnome.Shell.Extensions.VampireConnect.Plugin.MPRIS',
...
var Plugin = GObject.registerClass({
    GTypeName: 'VampireConnectMPRISPlugin',
...
const PlayerRemote = GObject.registerClass({
    GTypeName: 'VampireConnectMPRISPlayerRemote',
    ...
    async export() {
        try {
            ...
            this._ownerId = Gio.bus_own_name_on_connection(
                this._connection,
                `org.mpris.MediaPlayer2.VampireConnect.${name}`,
