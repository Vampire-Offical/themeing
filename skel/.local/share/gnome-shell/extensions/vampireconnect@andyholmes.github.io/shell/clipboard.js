 ...
 * DBus Interface Info
 */
const DBUS_NAME = 'org.gnome.Shell.Extensions.VampireConnect.Clipboard';
const DBUS_PATH = '/org/gnome/Shell/Extensions/VampireConnect/Clipboard';
const DBUS_NODE = Gio.DBusNodeInfo.new_for_xml(`
<node>
  <interface name="org.gnome.Shell.Extensions.VampireConnect.Clipboard">
    <!-- Methods -->
...
var Clipboard = GObject.registerClass({
    GTypeName: 'VampireConnectShellClipboard',
}, class VampireConnectShellClipboard extends GjsPrivate.DBusImplementation {
