...
var ListBox = class ListBox extends PopupMenu.PopupMenuSection {
    ...
    constructor(params) {
        ...
        this.box.add_style_class_name('vampireconnect-list-box');
...
var IconButton = GObject.registerClass({
    GTypeName: 'VampireConnectShellIconButton',
}, class Button extends St.Button {

    _init(params) {
        super._init({
            style_class: 'vampireconnect-icon-button',
            can_focus: true,
        });
        Object.assign(this, params);
...
var IconBox = class IconBox extends PopupMenu.PopupMenuSection {
    ...
    constructor(params) {
        ...
        this.box.style_class = 'vampireconnect-icon-box';
