...
var Battery = GObject.registerClass({
    GTypeName: 'VampireConnectShellDeviceBattery',
}, class Battery extends St.BoxLayout {

    _init(params) {
        super._init({
            reactive: true,
            style_class: 'vampireconnect-device-battery',
            track_hover: true,
        });
...
var SignalStrength = GObject.registerClass({
    GTypeName: 'VampireConnectShellDeviceSignalStrength',
}, class SignalStrength extends St.BoxLayout {

    _init(params) {
        super._init({
            reactive: true,
            style_class: 'vampireconnect-device-signal-strength',
            track_hover: true,
        });
        Object.assign(this, params);
...
var Menu = class Menu extends PopupMenu.PopupMenuSection {
    ...
    constructor(params) {
        ...
        this.actor.add_style_class_name('vampireconnect-device-menu');
        ...
        // Title -> Name
        this._title.label.style_class = 'vampireconnect-device-name';
...
var Indicator = GObject.registerClass({
    GTypeName: 'VampireConnectDeviceIndicator',
    ...
    _init(params) {
        ...
        this._icon = new St.Icon({
            ...
            style_class: 'system-status-icon vampireconnect-device-indicator',
        });
